...
INSERT INTO villekulla.private_items (id, name, description, created_at)
VALUES (
...
-- Seed blog posts
INSERT INTO villekulla.content_blog_posts (id, slug, title, excerpt, body, author_id, is_published, published_at, created_at)
VALUES
  (
...
INSERT INTO villekulla.content_blog_post_comments (id, blog_post_id, author_id, body, created_at)
VALUES
  (
