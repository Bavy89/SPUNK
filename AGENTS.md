...
Never include "Co-Authored-By: Claude" or any mention of Claude, Anthropic, or AI tools in commit messages. Write commit messages as if they were written by the developer.
